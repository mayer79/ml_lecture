...
$$
Thus, taking logarithms of covariables not only deals with outliers, it also offers us the possibility to talk about percentages.
...
$$
where $Y$ conditional on the covariables belongs to the so-called exponential dispersion family and $g$ is a transformation. 
