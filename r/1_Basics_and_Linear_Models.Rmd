...
Usually, we are interested in modeling a specific property of $y$, usually its mean (= expectation). In that case, we can make above approximate relationship more explicit:
$$
  E(y) = f(X).
$$
