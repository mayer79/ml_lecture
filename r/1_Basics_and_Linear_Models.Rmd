...
In this first chapter, we have introduced basic notations. Then, we have revisited multiple linear regression and some of its many aspects. To round up the chapter, we met a generalization, namely the generalized linear model GLM that includes the logistic regression abd Poisson count regression.
