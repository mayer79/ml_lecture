...
ix <- partition(
  diamonds$price, p = c(train = 0.8, valid = 0.2), seed = 9838, type = "basic"
)
...
However, if the rows are not independent, e.g. for time series data or grouped data, such a strategy is flawed and leads to overly optimistic results. **This is one of the most common reasons for a poor model.**
