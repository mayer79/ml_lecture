...
2. As an alternative to *grouped* splitting, repeat the last example also on data deduplicated by `price` and all covariables. Do the results change? Do you think these results are overly pessimistic?
