...
Furthermore, the performance difference between training and validation data gives an impression of the amount of overfitting.
...
ix <- partition(diamonds$price, p = c(train = 0.8, valid = 0.2), 
                seed = 9838, type = "basic")
