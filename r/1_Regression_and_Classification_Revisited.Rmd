...
The more time we invest in the descriptive analysis, the more we learn about the data, which is essential for successful modeling. Besides getting used to the data set, we might identify data errors, join keys, variables with high number of missing values
