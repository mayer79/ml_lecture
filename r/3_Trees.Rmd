...
Reasonable ragularization parameters are chosen by randomized or grid search CV. Usually, this takes a couple of iterations.
...
We will use XGBoost to fit diamond prices. As loss and evaluation metric, we will use MSE.

The basic strategy was as follows:

1. Using default regularization and early stopping, a learning rate of 5% provided a convenient amount of about 160 boosting rounds.
2. Randomized search CV was run a couple of times until good ranges for the regularization parameters were found. The final search is kept for later.
...
1. Study the documentation of XGBoost to figure out how to make the model monotonically increasing in carat. Test your insights without rerunning grid search in last example. How does the partial dependence plot for carat look now?
