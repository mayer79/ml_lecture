...
fit <- xgb.train(
  params = params, data = dtrain, print_every_n = 50, nrounds = cvm$early_stop$best_iteration
)

# Test performance
rmse(y_test, predict(fit, data.matrix(X_test)))  # 544.5
```
