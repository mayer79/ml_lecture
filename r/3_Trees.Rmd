...
In this chapter, we will go through methods based on decision trees. A single decision tree usually does not perform very well. Still trees are important because they work extremely well as "ensembles", i.e. combinations of many trees: the random forest and gradient boosting. We will have a look at them after introducing the concept of a decision tree.
