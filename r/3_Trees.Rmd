...
3. Use the best parameter combination (incl. number of trees) to fit the model on the training data. "Best" typically means in terms of CV performance. Depending on the situation, it can also mean "good performance and not too heavy overfit compared to training performance" or "good performance and not too many trees" or some other criterion.
