...
if (tune) {
  ...
  cvm   # -> a lr of 0.02 provides about 400 trees, which is a convenient amount
...
3. Optional. Study the documentation of [LightGBM](https://lightgbm.readthedocs.io/en/latest/). Use LightGBM to develop a strong competitor to the XGBoost diamond model. The XGBoost code needs to be slightly adapted. Compare grid search time.
