...
1. Study the documentation of the tree-fitting algorithm. What parameters will have an impact on tree size?
...
3. Use the performance on the validation data to optimize one of the parameters found in 1.
