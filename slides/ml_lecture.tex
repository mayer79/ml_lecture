...
\begin{frame}
	...
	\begin{itemize}
		\item Works at the Federal Office of Public Health (FOPH) in Switzerland
		\item Statistical Computing (University of Bern): \url{https://github.com/mayer79/statistical_computing_material}
